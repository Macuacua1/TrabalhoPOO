...
import static DaoClasse.FornecedorDao.sessao;
...
public class UsuarioDao implements Serializable{
    ...
    public void salvar(Usuario cli){
        ...
        sessao.getTransaction().commit();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao salvar o Usuario" +e);
            e.printStackTrace();
    }
     
    }
 
     public void  apagarUsuario(Usuario us) throws HibernateException{
        ...
        sessao.getTransaction().commit();
            ...
            JOptionPane.showMessageDialog(null, "Nao e possivel apagar o usuario" +e);
            e.printStackTrace();
    }
   }
     public void  upDateUsuario(Usuario us) throws HibernateException{
        ...
        sessao.getTransaction().commit();
            ...
            JOptionPane.showMessageDialog(null, "Nao e possivel apagar usuario" +e);
            e.printStackTrace();
    }
   }  
...
//Class tipo,int id
    public void apagarUsuario(int codigo) throws HibernateException{
          ...
          try{
            ...
            sessao.beginTransaction();
            Usuario us = (Usuario)sessao.get(Usuario.class, codigo);
    sessao.delete(us);
